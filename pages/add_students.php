...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Student Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <form role="form" method="post" action="">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="" placeholder="Student Name" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    <label>Class</label>
                                                    <input type="text" name="class" class="form-control" id="" placeholder="class" >
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="subjects" class="form-control" id="" placeholder="Subjects You Want to Read" >
