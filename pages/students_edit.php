...
if ($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if (count($errors)==0){
        ...
        $query="INSERT INTO students (name,mob,class,subjects,language,tutor,address,gender,date) VALUES ('$name','$mob','$class','$subjects','$language','$tutor','$address','$gender','$date')";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="students_process.php">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="<?php echo $res['name']?>" class="form-control" id="" placeholder="Student Name" >
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="mob" class="form-control" value="<?php echo $res['mob']?>" id="" placeholder="Mobile Number" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    <label>Class</label>
                                                    <input type="text" name="class" class="form-control" value="<?php echo $res['class']?>" id="" placeholder="class" >
                                                    <span class="error"><?php if (isset($errors['class'])) echo $errors['class'] ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    <label>Subjects You Want to Read</label>
                                                    <input type="text" name="subjects" class="form-control" id="" value="<?php echo $res['subjects']?>" placeholder="Subjects You Want to Read" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="language" class="form-control" id="" value="<?php echo $res['language']?>" placeholder="Communication Language" >
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tutor" class="form-control" value="<?php echo $res['tutor']?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address" class="form-control" id="" value="<?php echo $res['address']?>" placeholder="Local Address" >
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    <label>Gender</label>
                                                    <input type="text" class="form-control" name="gender" value="<?php echo $res['gender']?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="text" name="date" class="form-control" id="date" value="<?php echo $res['date']?>" placeholder="DD/MM/YYYY" autocomplete="off">
