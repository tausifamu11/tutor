...
$search="SELECT * FROM tutors WHERE CONCAT ('id','name','mob','qualification','subjects','language','tutor','address','gender','date') LIKE '.%".$value_to_search."%' ";
    ...
    $tutors=mysqli_fetch_all($result);
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <?php endif?>
                    <h1 class="page-header">Tutors Details</h1>
                    <div class="" align="right">
                        <a href="add_tutors.php" class="btn btn-info btn-sm">Add Tutors</a>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="table">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>Subjects You Want to Teach</th>
                                        ...
                                        <?php foreach ($tutors as $tutor):?>
                                            <tr>
                                                ...
                                                <td><?php echo $tutor[1]?></td>
                                                <td><?php echo $tutor[2]?></td>
                                                <td><?php echo $tutor[3]?></td>
                                                <td><?php echo $tutor[4]?></td>
                                                <td><?php echo $tutor[5]?></td>
                                                <td><?php echo $tutor[6]?></td>
                                                <td><?php echo $tutor[7]?></td>
                                                <td><?php echo $tutor[8]?></td>
                                                <td><?php echo $tutor[9]?></td>
                                                <td>
                                                    <a href="tutors_edit.php?edit=<?php echo $tutor[0]; ?>" class="btn btn-success btn-sm" style="margin-right: 4px">Edit</a>
                                                    <a href="tutors_process.php?delete=<?php echo $tutor[0]; ?>" class="btn btn-danger btn-sm dlt_btn" style="margin-right: 4px">Delete</a>
                                                </td>
