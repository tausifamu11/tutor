...
<?php if(isset($_GET['edit'])){
    $id=$_GET['edit'];
    $q="SELECT * FROM tutors WHERE id='$id'";
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Tutors Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="tutors_process.php">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <input type="hidden" name="id" value="<?php echo $res['id']?>">
                                                <div class="form-group">
                                                    <label>Student Name</label>
                                                    <input type="text" name="name" value="<?php echo $res['name']?>" class="form-control" id="" placeholder="Student Name" required >
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="mob" class="form-control" value="<?php echo $res['mob']?>" id="" placeholder="Mobile Number" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="qualification" class="form-control" value="<?php echo $res['qualification']?>" id="" placeholder="class" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                <div class="form-group">
                                                    <label>Gender</label>
                                                    <input type="text" name="gender" class="form-control" value="<?php echo $res['gender']?>">
