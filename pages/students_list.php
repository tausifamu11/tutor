...
if (isset($_POST['valuetosearch'])){
    ...
    $search="SELECT * FROM students WHERE CONCAT ('id','name','mob','qualification','subjects','language','tutor','address','gender','date') LIKE '.%".$value_to_search."%' ";
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="" align="right">
                        <a href="add_students.php" class="btn btn-info btn-sm"  >Add Students</a>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <div class="table">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>Mobile Number</th>
                                            <th>Class</th>
                                            <th>Subjects You Want to Read</th>
                                        ...
                                        <?php foreach ($students as $student):?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="students_edit.php?edit=<?php echo $student[0]; ?>" class="btn btn-success" style="margin-right: 4px">Edit</a>
                                                    <a href="students_process.php?delete=<?php echo $student[0]; ?>" class="btn btn-danger delet_btn" style="margin-right: 4px">Delete</a>
                                                </td>
